...
export default function LoadingScreen() {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#4a5a52] overflow-hidden">
      ...
      <div className="relative z-10 text-center">
        ...
        <motion.svg
          className="absolute top-32 right-20 w-16 h-16 text-[#5a8a6a] opacity-40"
          viewBox="0 0 100 100"
          animate={{ rotate: 360 }}
        ...
        <motion.svg
          className="absolute bottom-32 left-20 w-14 h-14 text-[#4a8fff] opacity-40"
          viewBox="0 0 100 100"
          animate={{ y: [-10, 10, -10] }}
